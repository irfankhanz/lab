...
(function($) {
  'use strict';
var dataSet = [
    [ "<img src='../../assets/img/dashboard/client-1.jpg' > Denise", "Old York, Abington", "Fever", "7", "	(836) 257 1379", "denisestevens@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-2.jpg'> Dennis", "Juniper Drive, Saginaw", "Cancer", "34", "(933) 137 6201", "dennissalazar@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-3.jpg'> Jennifer", "Leland, NC", "Heart Attack", "35", "(207) 808 8863", "jenniferrobinson@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-4.jpg'> Joshua", "Bonita Springs", "Cold", "34", "	(407) 554 4146", "	joshuaguzman@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-5.jpg'> Charles", "Birch Street, El Paso", "Cancer", "	32", "(380) 141 1885", "charlesortega@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-6.jpg'> Judy Clark", "Woodside Circle, Pensacola", "Diabeties", "34", "	(359) 969 3594", "judy.clark@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-7.jpg'>  Julia Sims", "Walker Dr, Houma, LA, United States", "Celiac ", "27", "	(680) 432 2662", "juliasims@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-8.jpg'>  Kyle", "Fairways Cir, Vero Beach", "Fever", "	7", "	(981) 756 6128", "	kylebowman@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-9.jpg'>  Linda", "Victory Garden, Tallahassee", "Heart Attack", "24", "(218) 661 8316", "	lindacarpenter@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-1.jpg'>  Marie", "New Haven, Columbia", "Cold", "22", "(634) 09 3833", "mariehoward@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-2.jpg'> Melissa", "Milwaukee, WI", "Cancer", "35", "(192) 494 8073", "melissaburton@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-3.jpg'>  Patrick", "Commerce, TX", "Celiac ", "21", "(785) 580 4514", "patrickknight@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-4.jpg'>  Sandra", "Linden Avenue, Orlando", "Liver Disease", "24", "	(797) 506 1265", "sandramendez@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-5.jpg'>  Terry Baker", "Hempstead, NY", "Diabeties", "63", "(376) 150 6975", "	terrybaker@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-6.jpg'>  Tatyana","Saginaw, MI,", "Fever ", "34", "(933) 137 6201", "tatyanafitzpatrick@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-7.jpg'>  Michael",  "Linden Avenue, Orlando", "Celiac ", "24", "	(797) 506 1265", "michaelsilva@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-8.jpg'>  Paul Byrd", "Milwaukee, WI", "Asthma", "35", "(192) 494 8073", "paulbyrd@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-9.jpg'>  Gloria ", "LA, United States", "Cold", "27", "	(680) 432 2662", "glorialittle@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-1.jpg'>  Bradley", "Victory Garden, Tallahassee", "Liver Disease", "24", "(218) 661 8316", "	bradleygreer@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-2.jpg'>  Dai Rios", "Fairways Cir, Vero Beach", "Heart Attck", "	7", "	(981) 756 6128", "dairiosn@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-3.jpg'>  Jenette ", "Birch Street, El Paso", "Autoimmune", "	32", "(380) 141 1885", "jenettecaldwell@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-4.jpg'>  Yuri Berry", " LA, United States", "Fever", "27", "	(680) 432 2662", "yuriberry@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-5.jpg'>  Caesar ", "Birch Street, El Paso", "Asthma", "	32", "(380) 141 1885", "caesarvance@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-6.jpg'>  Doris ", "Victory Garden, Tallahassee", "Diabeties", "24", "(218) 661 8316", "	doriswilder@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-7.jpg'>  Angelica",  "Linden Avenue, Orlando","Liver Disease",  "24", "	(797) 506 1265", "angelicaramos@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-8.jpg'>  Joyce", "Milwaukee, WI", "Asthma", "35", "(192) 494 8073", "gavinjoyce@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-9.jpg'>  Jennifer ", "Milwaukee, WI","Autoimmune",  "35", "(192) 494 8073", "jenniferchang@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-1.jpg'>  Brenden",  "New Haven, Columbia", "Infectious", "22", "(634) 09 3833", "brendenwagner@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-2.jpg'>  Fiona ", "LA, United States", "Colitis", "27", "	(680) 432 2662", "fionagreen@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-3.jpg'>  Shou Itou", "Fairways Cir, Vero Beach", "Asthma", "	7", "	(981) 756 6128", "shouitou@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-4.jpg'>  Michelle",  "Linden Avenue, Orlando","Infectious",  "24", "	(797) 506 1265", "Michelle@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-5.jpg'>  Suki Burks","Milwaukee, WI", "Colitis", "35", "(192) 494 8073", "sukiburks@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-6.jpg'>  Prescott", "Milwaukee, WI", "Infectious", "35", "(192) 494 8073", "prescottbartlett@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-7.jpg'>  Gavin ", "Fairways Cir, Vero Beach", "Autoimmune", "	7", "	(981) 756 6128", "gavincortez@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-8.jpg'>  Martena", "LA, United States", "Diabeties", "27", "	(680) 432 2662", "martenamccray@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    [ "<img src='../../assets/img/dashboard/client-9.jpg'>  Unity",  "New Haven, Columbia", "Celiac ", "22", "(634) 09 3833", "butler@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ]
  ];
  ...
  var dataSet1 = [
      ...
      [ "4",  "Sandra", "Client Supports","Daniel", "<span class='badge badge-outline-success'>Active</span>",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      ...
      [ "12","Jenni", "Client Supports","Bella", "<span class='badge badge-outline-danger'>Inactive</span>", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    ...
    var dataSet2 = [
        ...
        [ "4", "Judy Clark", "Client Supports", "Tuesday", "9:00", "11:00", "<span class='badge badge-outline-success'>Active</span>",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
        ...
        [ "12", "Charles", "Client Supports", "Sunday", "9:00", "11:00",  "<span class='badge badge-outline-success'>Active</span>", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      ...
      var dataSet3 = [
          [ "APT0001", "<img src='../../assets/img/dashboard/client-1.jpg'>Denise", "39", "Henry Daniels", "Cardiology", "11 Dec 2019", "10:00am-12:00am", "Cold",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0002", "<img src='../../assets/img/dashboard/client-8.jpg'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2019", "10:00am-12:00am",  "Fever",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0003", "<img src='../../assets/img/dashboard/client-4.jpg'>Joshua", "42", "Gavin Joyce", "Neurology", "6 Jan 2020", "10:00am-12:00am",  "heart", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0004", "<img src='../../assets/img/dashboard/client-9.jpg'>Judy", "23", "Yuri Berry", "Client Supports", "19 Dec 2019", "10:00am-12:00am", "Diabeties", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0005", "<img src='../../assets/img/dashboard/client-2.jpg'>Kyle", "55", "Henry Daniels", "Radiotherapy","15 Dec 2019", "10:00am-12:00am", "Cold",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0006", "<img src='../../assets/img/dashboard/client-3.jpg'>Denise", "39", "Henry Daniels", "Cardiology","11 Dec 2019", "10:00am-12:00am", "heart",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0007", "<img src='../../assets/img/dashboard/client-7.jpg'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2019", "10:00am-12:00am","Diabeties", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0008", "<img src='../../assets/img/dashboard/client-3.jpg'>Joshua", "42", "Gavin Joyce", "Neurology", "6 Jan 2020", "10:00am-12:00am",  "Fever", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0009", "<img src='../../assets/img/dashboard/client-8.jpg'>Judy", "23", "Yuri Berry", "Client Supports", "19 Dec 2019", "10:00am-12:00am", "Asthma",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a0", "<img src='../../assets/img/dashboard/client-4.jpg'>Kyle", "55", "Henry Daniels", "Radiotherapy", "15 Dec 2019", "10:00am-12:00am", "heart",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a1", "<img src='../../assets/img/dashboard/client-6.jpg'>Denise", "39", "Henry Daniels", "Cardiology", "11 Dec 2019", "10:00am-12:00am",  "Cold",    "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a2", "<img src='../../assets/img/dashboard/client-9.jpg'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2019", "10:00am-12:00am", "Asthma",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a3", "<img src='../../assets/img/dashboard/client-3.jpg'>Denise", "39", "Henry Daniels", "Cardiology", "11 Dec 2019", "10:00am-12:00am",  "Fever",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a4", "<img src='../../assets/img/dashboard/client-1.jpg'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2019", "10:00am-12:00am",  "Diabeties",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a5", "<img src='../../assets/img/dashboard/client-3.jpg'>Denise", "39", "Henry Daniels", "Cardiology", "11 Dec 2019", "10:00am-12:00am", "heart",     "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a6", "<img src='../../assets/img/dashboard/client-7.jpg'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2019", "10:00am-12:00am",  "Cold",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
